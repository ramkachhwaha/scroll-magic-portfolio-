...
var _config = {
	...
	overwrite: false,
	delay: 0
}, _suppressOverwrites, _bigNum$1 = 1e8, _tinyNum = 1 / _bigNum$1, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt = Math.sqrt, _cos = Math.cos, _sin = Math.sin, _isString = function _isString(value) {
...
var _addComplexStringPropTween = function _addComplexStringPropTween(target, prop, start, end, setter, stringFilter, funcParam) {
	...
	if (!tl || keyframes && !vars.stagger) {
		...
		} else if (runBackwards && dur) if (prevStartAt) !autoRevert && (tween._startAt = 0);
		else {
...
* @author: Jack Doyle, jack@greensock.com
*/
var _win, _doc, _docElement, _pluginInitted, _tempDiv, _recentSetterPlugin, _windowExists = function _windowExists() {
	return typeof window !== "undefined";
	...
	init: function init(target, vars, tween, index, targets) {
		...
		for (p in vars) {
			...
			if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
				...
				} else if (!(p in style)) if (p in target) this.add(target, p, startValue || target[p], relative ? relative + endValue : endValue, index, targets);
				else {
