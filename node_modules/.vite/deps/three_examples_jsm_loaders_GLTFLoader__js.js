...
var GLTFMaterialsUnlitExtension = class {
	...
	extendParams(materialParams, materialDef, parser) {
		...
		if (metallicRoughness) {
			...
			if (metallicRoughness.baseColorTexture !== void 0) pending.push(parser.assignTexture(materialParams, "map", metallicRoughness.baseColorTexture, sRGBEncoding));
		}
...
var GLTFMaterialsSheenExtension = class {
	...
	extendMaterialParams(materialIndex, materialParams) {
		...
		const extension = materialDef.extensions[this.name];
		if (extension.sheenColorFactor !== void 0) materialParams.sheenColor.fromArray(extension.sheenColorFactor);
		if (extension.sheenRoughnessFactor !== void 0) materialParams.sheenRoughness = extension.sheenRoughnessFactor;
		if (extension.sheenColorTexture !== void 0) pending.push(parser.assignTexture(materialParams, "sheenColorMap", extension.sheenColorTexture, sRGBEncoding));
...
var GLTFMaterialsSpecularExtension = class {
	...
	extendMaterialParams(materialIndex, materialParams) {
		...
		if (extension.specularColorTexture !== void 0) pending.push(parser.assignTexture(materialParams, "specularColorMap", extension.specularColorTexture, sRGBEncoding));
		return Promise.all(pending);
	}
};
/**
...
var GLTFTextureTransformExtension = class {
	...
	extendTexture(texture, transform) {
		...
		if (transform.offset === void 0 && transform.rotation === void 0 && transform.scale === void 0) return texture;
...
var GLTFMaterialsPbrSpecularGlossinessExtension = class {
	...
	extendParams(materialParams, materialDef, parser) {
		...
		if (pbrSpecularGlossiness.diffuseTexture !== void 0) pending.push(parser.assignTexture(materialParams, "map", pbrSpecularGlossiness.diffuseTexture, sRGBEncoding));
...
var GLTFParser = class {
	...
	*/
	assignTexture(materialParams, mapName, mapDef, encoding) {
		...
		return this.getDependency("texture", mapDef.index).then(function(texture) {
			...
			if (encoding !== void 0) texture.encoding = encoding;
	...
	*/
	loadMaterial(materialIndex) {
		...
		if (materialDef.emissiveTexture !== void 0 && materialType !== MeshBasicMaterial) pending.push(parser.assignTexture(materialParams, "emissiveMap", materialDef.emissiveTexture, sRGBEncoding));
	...
	*/
	loadAnimation(animationIndex) {
		...
		return Promise.all([
			...
			return new AnimationClip(animationDef.name ? animationDef.name : "animation_" + animationIndex, void 0, tracks);
		});
	}
