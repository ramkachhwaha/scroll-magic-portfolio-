...
var NumberController = class extends Controller {
	...
	updateDisplay() {
		...
		if (!this._inputFocused) this.$input.value = value;
		return this;
	}
	_initInput() {
		this.$input = document.createElement("input");
...
var GUI = class GUI {
	...
	*
	*/
	constructor({ parent, autoPlace = parent === void 0, container, width, title = "Controls", injectStyles = true, touchStyles = true } = {}) {
		/**
